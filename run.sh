...
wait
tar -cvzf SADE.tgz tmp/*
rm -rf tmp

# Compare three self-adaptive strategies on Cuckoo Search with Difference Term
# python TestCS.py ./SOPyml/SOP1.yml ./ALGOyml/PECSD.yml &
# python TestCS.py ./SOPyml/SOP2.yml ./ALGOyml/PECSD.yml &
# python TestCS.py ./SOPyml/SOP3.yml ./ALGOyml/PECSD.yml &
# python TestCS.py ./SOPyml/SOP4.yml ./ALGOyml/PECSD.yml &
# python TestCS.py ./SOPyml/SOP1.yml ./ALGOyml/JACSD.yml &
# python TestCS.py ./SOPyml/SOP2.yml ./ALGOyml/JACSD.yml &
# python TestCS.py ./SOPyml/SOP3.yml ./ALGOyml/JACSD.yml &
# python TestCS.py ./SOPyml/SOP4.yml ./ALGOyml/JACSD.yml &
# python TestCS.py ./SOPyml/SOP1.yml ./ALGOyml/RPCSD.yml &
# python TestCS.py ./SOPyml/SOP2.yml ./ALGOyml/RPCSD.yml &
# python TestCS.py ./SOPyml/SOP3.yml ./ALGOyml/RPCSD.yml &
# python TestCS.py ./SOPyml/SOP4.yml ./ALGOyml/RPCSD.yml &
...
wait
tar -cvzf PEDE_nstep10-50.tgz tmp/*
rm -rf tmp
...
wait
tar -czvf PECS_nstep1-5.tgz tmp/*
rm -rf tmp
